...
run_biting_sim(pr_symp_infec = 0.05, pr_symp_non_infec = 0.05, pr_clear = 0.85, pr_off_feed = 0.01, 
               ...
               scenario_name = "Season075_05_NoMove_longDry_20", n_sim=20)
...
run_biting_sim(pr_symp_infec = 0.05, pr_symp_non_infec = 0.05, pr_clear = 0.85, pr_off_feed = 0.01, 
               ...
               scenario_name = "Season08_045_NoMove_longDry_20", n_sim=20)
...
run_biting_sim(pr_symp_infec = 0.05, pr_symp_non_infec = 0.05, pr_clear = 0.85, pr_off_feed = 0.01, 
               ...
               scenario_name = "Season085_04_NoMove_longDry_20", n_sim=20)
...
run_biting_sim(pr_symp_infec = 0.05, pr_symp_non_infec = 0.05, pr_clear = 0.85, pr_off_feed = 0.01, 
               ...
               scenario_name = "Season09_035_NoMove_longDry_20", n_sim=20)
...
run_biting_sim(pr_symp_infec = 0.05, pr_symp_non_infec = 0.05, pr_clear = 0.85, pr_off_feed = 0.01, 
               ...
               scenario_name = "Season095_03_NoMove_longDry_20", n_sim=20)