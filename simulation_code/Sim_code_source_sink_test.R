...
run_biting_sim(pr_symp_infec = 0.05, pr_symp_non_infec = 0.05, pr_clear = 0.85, pr_off_feed = 0.01, 
               ...
               n_p_a1 = 100, n_m_a1 = 30000/2, pr_move_a1 = 0.01, pr_move_a2 = 0.005, prop_mobile_a1 = 0.1, prop_mobile_a2 = 0.05,
               scenario_name = "SourceSink001_01", n_sim=5)

run_biting_sim(pr_symp_infec = 0.05, pr_symp_non_infec = 0.05, pr_clear = 0.85, pr_off_feed = 0.01, 
               pr_on_feed = 0.1,pr_hum_to_mos = 0.6, pr_mos_to_hum = 0.3, 
               pr_num_biting = c(0.6, 0.35, 0.04,0.01, 0,0,0), n_m=30000, 
               n_p_a1 = 100, n_m_a1 = 30000/2, pr_move_a1 = 0.015, pr_move_a2 = 0.005, prop_mobile_a1 = 0.15, prop_mobile_a2 = 0.05,
               scenario_name = "SourceSink0015_015", n_sim=5)

run_biting_sim(pr_symp_infec = 0.05, pr_symp_non_infec = 0.05, pr_clear = 0.85, pr_off_feed = 0.01, 
               pr_on_feed = 0.1,pr_hum_to_mos = 0.6, pr_mos_to_hum = 0.3, 
               pr_num_biting = c(0.6, 0.35, 0.04,0.01, 0,0,0), n_m=30000, 
               n_p_a1 = 100, n_m_a1 = 30000/2, pr_move_a1 = 0.02, pr_move_a2 = 0.005, prop_mobile_a1 = 0.2, prop_mobile_a2 = 0.05,
               scenario_name = "SourceSink002_02", n_sim=5)


run_biting_sim(pr_symp_infec = 0.05, pr_symp_non_infec = 0.05, pr_clear = 0.85, pr_off_feed = 0.01, 
               pr_on_feed = 0.1,pr_hum_to_mos = 0.6, pr_mos_to_hum = 0.3, 
               pr_num_biting = c(0.6, 0.35, 0.04,0.01, 0,0,0), n_m=30000, 
               n_p_a1 = 100, n_m_a1 = 30000/2, pr_move_a1 = 0.03, pr_move_a2 = 0.005, prop_mobile_a1 = 0.25, prop_mobile_a2 = 0.05,
               scenario_name = "SourceSink003_025", n_sim=1)
